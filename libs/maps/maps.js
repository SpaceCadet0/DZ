...
var mapClass = function(){
    ...
    this.prepareProviderOptions = function(){
        switch (rlConfig['map_provider']){
            ...
            case 'google':
                this.layerUrl = 'https://mt{s}.google.com/vt/lyrs=m&hl=en&x={x}&y={y}&z={z}&scale={retina}';
                this.providerOptions = {
                    subdomains: ['', 1, 2, 3],
            ...
            case 'yandex':
                this.layerUrl = 'http://vec{s}.maps.yandex.net/tiles?l=map&v=4.55.2&z={z}&x={x}&y={y}&scale={retina}&lang=en_US';
                this.providerOptions = {
                    subdomains: ['01', '02', '03', '04'],
                    attribution: 'Map data &copy; <a href="http://yandex.ru/maps/">Yandex</a>',
                    retina: L.Browser.retina ? 2 : 1
                }
