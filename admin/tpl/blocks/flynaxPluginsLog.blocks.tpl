    ...
    <tr>
        ...
        <td class="list-body changelog_{$log_item.status}">
            <div class="changelog_item" id="pChangelog_{$pLog_key}">
                <a class="green_14" target="_blank" href="https://www.flynax.ru/plugins/{$log_item.path}.html#changelog" title="{$lang.learn_more_about} {$log_item.name}">{$log_item.name}</a>
