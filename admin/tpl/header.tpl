...
<script type="text/javascript">//<![CDATA[
    ...
    {foreach from=$ext_phrases item='phrase' key='key'}
       lang['{$key}'] = '{$phrase|escape:"javascript"}';
    {/foreach}

    lang['photo']           = '{$lang.photo|escape:"javascript"}';
    lang['of']              = '{$lang.of|escape:"javascript"}';
    lang['delete']          = '{$lang.delete|escape:"javascript"}';
    lang['manage']          = '{$lang.manage|escape:"javascript"}';
    lang['done']            = '{$lang.done|escape:"javascript"}';
    lang['loading']         = '{$lang.loading|escape:"javascript"}';
    lang['save']            = '{$lang.save|escape:"javascript"}';
    lang['characters_left'] = '{$lang.characters_left|escape:"javascript"}';
    lang['system_error']    = '{$lang.system_error|escape:"javascript"}';
    lang['update']          = '{$lang.update|escape:"javascript"}';
    lang['incompatible']    = '{$lang.plugin_not_compatible|escape:"javascript"}';
            ...
            <div class="outer">
                <div class="inner">
                    ...
                    <div id="buttons_bar">&nbsp;
                        ...
                        <a href="{$smarty.const.RL_URL_HOME}" target="_blank" class="button_bar"><span class="center_arrow">{$lang.front_end}<span></a>
                    </div>
                </div>
            </div>
        </div>
