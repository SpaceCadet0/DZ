...
class ListingPictureUpload extends AbstractFileUpload
{
    ...
    * 
    * 
    * @deprecated 4.7.0 - moved to ListingMedia static class
    */ 
    public function buildName($postfix, $position = 0, $extension = false) 
    {
        return ListingMedia::buildName($this->listingID, 'orig', $position, $extension, $this->options['dir_name']);
    }
    ...
    */ 
    ...
    {
        return ListingMedia::updateNames($this->listingID);
    }
