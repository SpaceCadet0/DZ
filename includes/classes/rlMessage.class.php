...
class rlMessage extends reefless
{
    ...
    /**
     * @deprecated 4.5.1
     * function moved to rlListingsAdmin.class.php>contactOwner
     **/

    public function ajaxContactOwner($name = false, $email = false, $phone = false, $message = false, $code = false, $listing_id = false, $box_index = false)
    {
        $err = "function rlListings -> " . __FUNCTION__ . " deprecated as of Flynax 4.5";
        $GLOBALS['rlDebug']->logger($err);
