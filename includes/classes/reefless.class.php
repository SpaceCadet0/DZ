    ...
    public function url($mode = 'page', $data = null, $customLang = '')
    {
        ...
        if ($config['multilingual_paths']) {
            ...
            if ($GLOBALS["pages_{$customLang}"]
                || ($page_info["Path_{$customLang}"] && $page_info['Key'] === $data['key'])
            ) {
                if ($page_info["Path_{$customLang}"] && !$GLOBALS["pages_{$customLang}"]) {
                    $GLOBALS["pages_{$customLang}"][$page_info['Key']] = $page_info["Path_{$customLang}"];
                }
        ...
        switch ($mode) {
            case 'listing':
                ...
                $categoryPath = $listing['Path'] ?: $listing['Category_path'];
            ...
            case 'page':
                ...
                if ($path) {
                    ...
                    : $firstNonModrewriteSign . 'page=' . $path . $add_url . $add_vars;
                }
                break;
            ...
            case 'category':
                ...
                $listingType = $GLOBALS['rlListingTypes']->types[$category['Type']];
